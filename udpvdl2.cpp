...
udpvdl2::udpvdl2(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::udpvdl2)
{
    ui->setupUi(this);
...
void udpvdl2::on_pushButton_clicked()
{
    struct tsPid21{
...
void udpvdl2::on_pushButton_4_clicked()
{
...
void udpvdl2::on_transmission_ratio_clicked()
{
    form.show();
...
void udpvdl2::on_pushButton_3_clicked()
{
    version.show();
}


void udpvdl2::on_version_clicked()
{

}


void udpvdl2::on_pushButton_2_clicked()
{

}


void udpvdl2::on_actionPARAM_REQ_triggered()
{
    /*-----------------------------------------------------------------------------------*/
...
void udpvdl2::on_actionPWR_SET_REQ_triggered()
{
...
void udpvdl2::on_actionMODE_SET_REQ_triggered()
{
    /*-------------Définition des champs de la trame ------------- */
...
void udpvdl2::on_actionPURGE_REQ_triggered()
{
    /*-------------Définition des champs de la trame ------------- */
...
void udpvdl2::on_actionPARAM_REQ_2_triggered()
{
    /*-----------------------------------------------------------------------------------*/
      // Algo de traitement de la fréquence
      //Il faut créer une liste qui prend la taille de la valeur de fréquence désiré
...
void udpvdl2::on_actionMODE_SET_REQ_2_triggered()
{
    /*-------------Définition des champs de la trame ------------- */
